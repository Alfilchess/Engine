...
namespace Motor
{
  ...
  public class cEval
  {
    ...
    //---------------------------------------------------------------------------------------------------------------------------
    public static readonly cEvalPesos[] m_Pesos = new cEvalPesos[6];
    public static readonly pnt[] m_PesosInternos = { Pnt(289, 344), Pnt(233, 201), Pnt(221, 273), Pnt(46, 0), Pnt(271, 0), Pnt(307, 0) };
    ...
    public static readonly val[][] m_Avanzado = new val[][] {
            new val[]{          
    ...
    public static readonly pnt[][] m_Amenazado = new pnt[][] {            
            new pnt[]{ Pnt(0, 0), Pnt( 7, 39), Pnt(24, 49), Pnt(24, 49), Pnt(41,100), Pnt(41,100) }, 
            new pnt[]{ Pnt(0, 0), Pnt(15, 39), Pnt(15, 45), Pnt(15, 45), Pnt(15, 45), Pnt(24, 49) }  
        };

    public static readonly pnt[] ThreatenedByPawn = new pnt[] {
            Pnt(0, 0), Pnt(0, 0), Pnt(56, 70), Pnt(56, 70), Pnt(76, 99), Pnt(86, 118)
        };

    public static readonly pnt[] Hanging = new pnt[] {
            Pnt(23, 20) , Pnt(35, 45)
        };
    ...
    public static readonly UInt64[] m_EspacioMasc = new UInt64[] {
    ...
    public static readonly int[] KingAttackWeights = new int[] { 0, 0, 2, 2, 3, 5 };
    ...
    public static pnt EvalAmenazas(cPosicion pos, cEvalInfo evalInfo, color colr)
    {
      ...
      if (weakEnemies != 0)
      {
        ...
        if (b != 0)
          nPuntos += m_Amenazado[0][cTypes.TipoPieza(pos.GetPieza(cBitBoard.LSB(b)))];

        b = weakEnemies & (evalInfo.m_Ataques[colr][cPieza.TORRE] | evalInfo.m_Ataques[colr][cPieza.DAMA]);
        if (b != 0)
          nPuntos += m_Amenazado[1][cTypes.TipoPieza(pos.GetPieza(cBitBoard.LSB(b)))];
