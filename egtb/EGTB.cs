...
namespace Gaviota
{
  public enum MateResult { WhiteToMate, BlackToMate, Draw, Unknown };
  ...
  public static class EGTB
  {
    ...
    public static ProbeResultType Probe(List<int> whiteSquares, List<int> blackSquares, List<int> whiteTypes, List<int> blackTypes, int realside, int epsq)
    {
      ...
      if (egtb_get_dtm(side, epsq, ref dtm))
      {
        ...
        else
        {
          ...
          else if (probeResult.stm == MateResult.BlackToMate)
          {
            ret = ply;
          }
        }
    ...
    static int bestx(int side, int a, int b)
    {
      ...
      int[][] comparison = new int[4][]  {
        ...
        /* draw  */ new int[4] {0, 3, 0, 0},
        /* wmate */ new int[4] {0, 1, 0, 0},
        /* bmate */ new int[4] {3, 3, 2, 0},
        /* forbid*/ new int[4] {3, 3, 3, 0}
