...
namespace InOut
{
  ...
  public class cLibro
  {
    ...
    //-- Las entradas están ordenadas según la clave en orden ascendente.
    public struct stLineaLibro
    {
      public UInt64 key;
      public UInt16 move;
      public UInt16 count;
    ...
    public cLibro()
    {
      m_Rand = new cAleatorio((int)(cReloj.Now() % 1000));
    }
    ...
    public bool Read(ref cLibro.stLineaLibro e)
    {
      ...
      m_Stream.Read(byteReg, 0, (int)SIZE_OF_BOOKENTRY);
      ...
      e.learn = (UInt32)(
          (((UInt64)byteReg[12]) << 24) |
          (((UInt64)byteReg[13]) << 16) |
          (((UInt64)byteReg[14]) << 8) |
          (((UInt64)byteReg[15]) << 0));
