...
namespace Motor
{
  ...
  public class cBonusPeones
  {
    ...
    private static int[] m_ColumnaBonus = new int[] { 1, 3, 3, 4, 4, 3, 3, 1 };
    ...
    private static pnt m_Avanzados = Pnt(4, 15);
    private static pnt m_SinDefensa = Pnt(20, 12);
